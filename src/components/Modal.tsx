  ...
  return (
    <>
      <div
        ...
        onClick={handleClose}
      >
        <div className="absolute border-2 top-1/2 left-1/2 transform w-4/6 -translate-x-1/2 -translate-y-1/2 bg-black shadow-2xl z-10 h-2/6 rounded-lg xl:w-2/6 xl:h-72">
